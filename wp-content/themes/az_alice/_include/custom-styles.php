    ...
    if ( !function_exists('az_custom_colors_header') ) {   
        ...
        function az_custom_colors_header() {
            ...
            $custom_colors_css = '
                ...
                .light-type #title-header-flexslider.flexslider .slider-content .slide-subtitle,.light-type #title-header-flexslider.flexslider .slider-content .slide-title,.light-type .box-content-titles .subheading,.light-type .box-content-titles .title,.light-type .logo-setup.logo-text,.light-type .mobile_video_button.normal-inside i,.light-type .optional-menu a,.light-type #az_header_language_list .lang a,.light-type .player_YT_Mod_button.normal-inside i,.light-type .scroll-btn-full-area-title-header i,.light-type .self_player_button.normal-inside i,.light-type .vimeo_player_button.normal-inside i,.no-touch .light-type .optional-menu a:hover { color: '.$options_alice['light_type_custom_color'].'; }
                ...
                .light-type .optional-menu .menu-share::before, .light-type .optional-menu .menu-search::before, .light-type #az_header_language_list::before { background: rgba('.implode(',', hex2rgb($options_alice['light_type_custom_color'])).',0.35); }
                ...
                .dark-type #title-header-flexslider.flexslider .slider-content .slide-subtitle,.dark-type #title-header-flexslider.flexslider .slider-content .slide-title,.dark-type .box-content-titles .subheading,.dark-type .box-content-titles .title,.dark-type .logo-setup.logo-text,.dark-type .mobile_video_button.normal-inside i,.dark-type .optional-menu a,.dark-type #az_header_language_list .lang a,.dark-type .player_YT_Mod_button.normal-inside i,.dark-type .scroll-btn-full-area-title-header i,.dark-type .self_player_button.normal-inside i,.dark-type .vimeo_player_button.normal-inside i,.no-touch .dark-type .optional-menu a:hover { color: '.$options_alice['dark_type_custom_color'].'; }
                ...
                .dark-type .optional-menu .menu-share::before,.dark-type .optional-menu .menu-search::before, .dark-type #az_header_language_list::before { background: rgba('.implode(',', hex2rgb($options_alice['dark_type_custom_color'])).',0.35); }
                ...
                #az_header_language_list .lang,.dropcap-color,.highlight-normal-text,.no-touch #cancel-comment-reply-link:hover,.no-touch #cd-zoom-in:hover i,.no-touch #cd-zoom-out:hover i,.no-touch #error-page .back-home:hover,.no-touch #twitter-feed-section .tweet_text a:hover,.no-touch .az-box-icon .box-wrapper-link:hover .box-title,.no-touch .az-social-profiles ul.az-social-profiles-link li a:hover,.no-touch .credits-social ul li a:hover,.no-touch .dark-type.footer-widget-area a:hover,.no-touch .footer .credits a:hover,.no-touch .mm-panel ul li a:hover,.no-touch .portfolio-filter li a:hover,.no-touch a:active,.no-touch a:focus,.no-touch a:hover,.normal-pagination.numbers-only a.active,.normal-pagination.numbers-only a.nothing-dot,.portfolio-filter li a.selected,a:active,a:focus,.no-touch .panel-title > a:hover { color: '.$options_alice['general_main_custom_color'].'; }
                ...
                #searchform input[type=text]:focus,.preloader,.respond-comment textarea:focus,.respond-field input:focus,.widget_search form input[type=text]:focus,.wpcf7 input:focus,.wpcf7 textarea:focus { border-color: '.$options_alice['general_main_custom_color'].'; }
