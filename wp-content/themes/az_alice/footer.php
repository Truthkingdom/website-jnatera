...
<footer class="footer">
	...
	<div class="footer-bottom-area">
		...
		<?php } else { ?>
			<p>&copy; <?php echo date( 'Y' ); ?> <a href="<?php echo home_url(); ?>"><?php bloginfo( 'name' ); ?></a>. <?php _e('Alice Theme by', AZ_THEME_NAME); ?> <a href="http://themeforest.net/user/Bluxart/?ref=Bluxart" target="_blank">Alessio Atzeni</a>. <?php _e('Powered by', AZ_THEME_NAME) ?> <a href="http://wordpress.org/" target="_blank">WordPress</a>.</p>
		<?php } ?>
		</div>
	</div>
</footer>
